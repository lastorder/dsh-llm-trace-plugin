 ...
 */
export function dqEscape(value: unknown): string {
  return String(value).replace(/[\\"`$]/g, '\\$&')
}
 ...
 */
export async function resolveRealApiKey(
  url: string,
 ...
 * plausible key.
 */
export function buildCurl(record: WireRecord, resolved: ResolvedCredential | undefined): string {
